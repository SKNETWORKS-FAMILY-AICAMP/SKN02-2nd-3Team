...
한국 전자상거래 시장 규모는 2010년 부터 2020년까지 연평균 19.7% 증가하여 2020년에는 그 규모가 131조원에 달했다. 이렇게 치열한 한국 전자상거래 시장에 최근 쿠팡, 알리익스프레스, 아마존 등의 외국계 자본들이 공격적인 투자를 바탕으로 점유율 경쟁에 뛰어들었다. 점유율 경쟁이 심화됨에 따라 기존 이커머스 기업들의 이탈고객도 꾸준히 늘어날 수 밖에 없는 실정이다. 이에 따라 고객이탈 데이터를 이용하여 고객들의 이탈여부를 분류하고, 잠재적 이탈고객을 관리할 수 있는 시스템의 도입을 제안하기 위해 이커머스 데이터 셋을 선정하였다.
